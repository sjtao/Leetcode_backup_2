...
/**
Runtime: 24 ms, faster than 38.98% of C++ online submissions for Max Area of Island.
Memory Usage: 23.1 MB, less than 87.78% of C++ online submissions for Max Area of Island.
*/
class Solution {
public:
    int area(vector<vector<int>>& grid, int m, int n, int r, int c){
